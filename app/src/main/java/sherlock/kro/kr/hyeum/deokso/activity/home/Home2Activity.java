...
public class Home2Activity extends AppCompatActivity {
    public static final String HomeDBName = "StudentHome2.db";
    ...
    private void showHomeData(boolean forceUpdate) {
        ...
        if (Tools.isOnline(getApplicationContext())) {
            if (Tools.isWifi(getApplicationContext()) || forceUpdate) {
                ...
                mTask.execute("https://docs.google.com/spreadsheets/d/1jeqHqKJClUrloOXMYME_SFotOz7_o9c1LjaOdCgxSCw/pubhtml?gid=1440554835&single=true");
            } else {
    ...
    class getHomeDownloadTask extends GoogleSheetTask {
        ...
        public void onPreDownload() {
            mDialog = new ProgressDialog(Home2Activity.this);
