...
import sherlock.kro.kr.hyeum.deokso.autoupdate.updateAlarm;
...
//                    builder.setMessage(R.string.no_network_msg);
                    ...
                    builder.setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int whichButton) {
                            ...
                            if ("ridsmnbj07".equals(securityXor.getSecurityXor(value, 01))) {
        ...
        private Preference.OnPreferenceChangeListener onPreferenceChangeListener = new Preference.OnPreferenceChangeListener() {
            ...
            public boolean onPreferenceChange(Preference preference, Object newValue) {
                ...
                if (preference instanceof EditTextPreference) {
                    ...
                    sherlock.kro.kr.hyeum.deokso.tool.Preference mPref = new sherlock.kro.kr.hyeum.deokso.tool.Preference(getActivity());
