package sherlock.kro.kr.hyeum.deokso.activity.notice;
...
public class NoticeSendActivity extends AppCompatActivity {
    ...
    private class HttpTask extends AsyncTask<String, Void, Boolean> {
        ...
        protected Boolean doInBackground(String... params) {
            try {
                HttpPost postRequest = new HttpPost("https://script.google.com/macros/s/AKfycbznKushM5VhJledMJCsEYIJXVQZAciJj60RTFzvTB97kyzE9UQ/exec");
